---
title: "Userguide for performing automatic gating with `cytometree`"
...
output: 
  rmarkdown::html_vignette:
    toc: yes
vignette: >
  %\VignetteIndexEntry{Userguide for performing automatic gating with `cytometree`}
...
In this example, we will use a dataset from the HIPC ([Human Immunology Project Consortium](https://www.immuneprofiling.org/) program where a PBMC sample from patient 12828 was analysed by Stanford. 
